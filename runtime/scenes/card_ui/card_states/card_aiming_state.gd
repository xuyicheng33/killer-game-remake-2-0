...
const MOUSE_Y_SNAPBACK_THRESHOLD_RATIO := 0.78
...
func on_input(event: InputEvent) -> void:	
	...
	var threshold := viewport_height * MOUSE_Y_SNAPBACK_THRESHOLD_RATIO
	var mouse_at_bottom := card_ui.get_global_mouse_position().y > threshold
