...
Usage:
  python3 tools/generate_battle_icons.py --output-dir art/ui/icons --size 64
"""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="art/ui/icons", help="Directory for icon PNG files.")
